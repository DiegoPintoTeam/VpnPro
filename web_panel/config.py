...
class Config:
    ...
    AUTO_DISK_HOUSEKEEPING_INTERVAL_MINUTES = _env_int('AUTO_DISK_HOUSEKEEPING_INTERVAL_MINUTES', 15, minimum=5)
    AUTO_DISK_HOUSEKEEPING_ON_GUARD = _env_bool('AUTO_DISK_HOUSEKEEPING_ON_GUARD', True)
    DISK_HOUSEKEEPING_TRIGGER_PERCENT = _env_int('DISK_HOUSEKEEPING_TRIGGER_PERCENT', 80, minimum=50)
