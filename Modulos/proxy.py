...
def main(host=IP, port=PORT):
    ...
    print "\033[1;32mIP:\033[1;32m " + IP
    print "\033[1;32mPUERTO:\033[1;32m " + str(PORT) + "\n"
    print "\033[0;34m━"*10,"\033[1;32m VpnPro","\033[0;34m━\033[1;32m"*11,"\n"
