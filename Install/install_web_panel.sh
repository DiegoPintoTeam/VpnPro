...
AUTO_LIMITER_INTERVAL_SECONDS="${AUTO_LIMITER_INTERVAL_SECONDS:-10}"
AUTO_TRIM_CONFIRMATION_SECONDS="${AUTO_TRIM_CONFIRMATION_SECONDS:-10}"
AUTO_TRIM_FIRST_STRIKE_LIMIT_ONE="${AUTO_TRIM_FIRST_STRIKE_LIMIT_ONE:-true}"
AUTO_TRIM_USER_COOLDOWN_SECONDS="${AUTO_TRIM_USER_COOLDOWN_SECONDS:-20}"
...
AUTO_TRIM_CONFIRMATION_SECONDS=${AUTO_TRIM_CONFIRMATION_SECONDS}
AUTO_TRIM_FIRST_STRIKE_LIMIT_ONE=${AUTO_TRIM_FIRST_STRIKE_LIMIT_ONE}
AUTO_TRIM_USER_COOLDOWN_SECONDS=${AUTO_TRIM_USER_COOLDOWN_SECONDS}
