...
AUTO_TRIM_CONFIRMATION_SECONDS="${AUTO_TRIM_CONFIRMATION_SECONDS:-90}"
AUTO_BLOCK_UDP_EXCESS="${AUTO_BLOCK_UDP_EXCESS:-false}"
...
AUTO_BLOCK_UDP_EXCESS=${AUTO_BLOCK_UDP_EXCESS}
